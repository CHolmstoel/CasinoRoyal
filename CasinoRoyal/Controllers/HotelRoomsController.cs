...
namespace CasinoRoyal.Controllers
{
    public class HotelRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HotelRoomID")] HotelRoom hotelRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HotelRoomID")] HotelRoom hotelRoom)
        {
            if (id != hotelRoom.HotelRoomID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!HotelRoomExists(hotelRoom.HotelRoomID))
                    {
                        return NotFound();
                    }
                    else
